...
public class StartPresenter implements Presenter {
    ...
    public void setView(@NonNull StartView view) {
        this.startView = view;
    }

    public void onLowLevelClicked() {
        startView.navigateToGame(1);
    }

    public void onMiddleLevelClicked() {
        startView.navigateToGame(2);
    }

    public void onHighLevelClicked() {
        startView.navigateToGame(3);
    }
