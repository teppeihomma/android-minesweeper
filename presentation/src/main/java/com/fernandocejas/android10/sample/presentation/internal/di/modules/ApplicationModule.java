...
import com.fernandocejas.android10.sample.data.cache.MemoryCacheImpl;
import com.fernandocejas.android10.sample.data.cache.UserCache;
import com.fernandocejas.android10.sample.data.cache.UserCacheImpl;
import com.fernandocejas.android10.sample.data.executor.JobExecutor;
import com.fernandocejas.android10.sample.data.repository.GameDataRepository;
...
public class ApplicationModule {
    ...
    @Provides
    @Singleton
    GameRepository provideGameRepository(GameDataRepository gameDataRepository) {
        return gameDataRepository;
    }

    @Provides
    @Singleton
    MemoryCache provideMemoryCache(MemoryCacheImpl memoryCache) {
        return memoryCache;
    }
}
