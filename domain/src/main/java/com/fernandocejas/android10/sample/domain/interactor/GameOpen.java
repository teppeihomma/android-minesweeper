...
public class GameOpen extends UseCase<GameBoard, GameOpen.Params> {

    private final GameRepository gameRepository;

    @Inject
    GameOpen(GameRepository gameRepository, ThreadExecutor threadExecutor,
    ...
    Observable<GameBoard> buildUseCaseObservable(Params params) {
        ...
        return this.gameRepository.open(params.x, params.y);
    }
